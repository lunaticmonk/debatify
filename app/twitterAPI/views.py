from flask import Blueprint,render_template,request,flash,redirect,url_for,session,g,jsonify,session
...
@api.route('/tweets', methods = ['GET','POST'])
def getTweets():
	chat_id = int(session['chat_id'])
	print chat_id
	query = models.Question.query.filter_by( id = chat_id ).first()
	# print query
	user = query.topic
	# user = 'ammaji'
